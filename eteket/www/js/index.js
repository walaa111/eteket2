...
var app = {
	...
	var inAppBrowserbRef = cordova.InAppBrowser.open('https://electrostar.ovplatform.tk', '_self', 'location=no,toolbar=no');
        inAppBrowserbRef = cordova.InAppBrowser.open('http://walaa.realdeal.com.eg/eteket/', '_self', 'location=no,toolbar=no','clearcache=no','clearsessioncache=no','zoom=no','hardwareback=no');
...
function initAd(){
        if ( window.plugins && window.plugins.AdMob ) {
            var ad_units = {
                ...
                android : {
                    banner: 'ca-app-pub-7251676025279948/2873223002',		//PUT ADMOB ADCODE HERE 
                    interstitial: 'ca-app-pub-7251676025279948/8176632522'	//PUT ADMOB ADCODE HERE 
                }
            };
